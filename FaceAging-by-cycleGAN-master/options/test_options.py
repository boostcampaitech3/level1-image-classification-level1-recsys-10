...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--use_pretrained_model', action='store_false', help='whether we should use pretrained model')
        parser.add_argument('--pretrained_model_name', type=str, default='0_cacd_regular1', help='name of the pretrained model we want to use for transfer learning, e.g. orange2apple')
        # ''-->0_cacd_regular
